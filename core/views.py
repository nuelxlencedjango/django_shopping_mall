...
class CheckoutView(View):
    ...
    def get(self ,*args ,**kwargs):
        try:
            ...
            context ={'form' :form ,
            'couponForm':CouponForm() ,'order' :order ,'DISPLAY_COUPON_FORM': True}
    ...
    def post(self ,*args ,**kwargs):
        ...
        try:            
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if is_valid_form([shipping_address1 ,shipping_address2 ,shipping_country ,shipping_zip]):
                        ...
                        street_address =shipping_address1 ,appartment_address=shipping_address2 ,
                ...
                use_defalut_billing = form.cleaned_data.get('use_default_billing')
                ...
                if same_billing_address:
                ...
                elif use_defalut_billing:
                    print('Useing the default billing address')
                    ...
                    if is_valid_form([billing_address1 ,billing_country,billing_zip]):
                        ...
                        street_address =billing_address1 ,appartment_address=billing_address2 ,
            ...
            return redirect('core:order-summary')
               ...
               # billing_address = Address(user =self.request.user ,
               # street_address =street_address ,appartment_address =appartment_address,
               # country =country ,zip = zip ,address_type='B')
                #,address_type='B'
...
class PaymentView(View):
    ...
    def post(self ,*args ,**kwargs):
        ...
        if form.is_valid():
            ...
            amount= int(order.get_total() * 100)  # always in cent
        ...
        try:
            if use_default:
                ...
                currency = "usd", customer =userprofile.stripe_customer_id)
            else:
            ...
            order_item.updated(ordered =True) 
           ...
           messages.warning(self.request , "Serious error occured. You were not charged,please try again later")
           return redirect("/")
